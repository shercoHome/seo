...
1. 为什么没有SEO秘籍
2. 搜索引擎算法就是一个秘密
3. SEO有绝招。（诸如 链接诱饵、CMS系统模板带来的高质量外链）
### （十）SEO不仅仅是排名
1. 更多是整站优化带来的新收录以及人工不可预期的长尾关键词
2. 地理定位及个性化搜索的原因
3. 标题吸引力、品牌效应、转化率等
### （十一）SEO不是作弊
对于用户：
1. 做关键词研究和竞争对手调查——了解用户需求
2. 扩展网站内容——满足用户需求
3. 优化网站架构及内链——提高用户体验
4. 页面优化——突出重点
5. 流量分析和策略改进——用户形为反馈
6. 外部链接建设——有效互动的公共关系  
对于搜索引擎：  
`搜索引擎友好、易于收录、主题突出、内容丰富的网站是为搜索引擎提供信息源，同时满足用户` 
### （十二）SEO与网站运营
网站运营：产品研发、物流管理、人员管理、品牌建设、网络营销……
网络营销：邮件营销、论坛营销、口碑营销、社会媒体、搜索营销……
搜索营销：PPC、SEO……
### （十三）内容为王
1. 原创内容是SEO的根本  
2. 内容策划的SEO策略  
...
5. 全站非链接排名因素
    ...
    7. 链接到被信任、有权重的网站
    8. ……
6. 社会化媒体排名因素（出现在百度百科、贴吧、词典、知道中）1
7. 用户数据排名因素
8. 负面排名因素
9. 地理定位因素
